...
def main():
    ...
    for penalty, C in zip(penalties, coefs):
        ...
        save_results(
            ...
            train_predictions,
            train_actual,
            os.path.join(args.output_dir, "train_cf_predictions", model_name + ".csv"),
        )
        save_results(
            test_names,
            test_ts,
            test_predictions,
            test_actual,
            os.path.join(args.output_dir, "test_cf_predictions", model_name + ".csv"),
        )
        save_results(
            val_names,
            val_ts,
            val_predictions,
            val_actual,
            os.path.join(args.output_dir, "val_cf_predictions", model_name + ".csv"),
        )
