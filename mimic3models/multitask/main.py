...
if args.mode == "train":
    ...
    test_reader = MultitaskReader(dataset_dir=os.path.join(args.data, args.data_subset))
    ...
    print(
        f"Saving the predictions in {args.data_subset}_predictions/task directories ..."
    )
    ...
    ihm_path = os.path.join(
        os.path.join(
            args.output_dir,
            f"{args.data_subset}_predictions/ihm",
    ...
    decomp_path = os.path.join(
        os.path.join(
            args.output_dir,
            f"{args.data_subset}_predictions/decomp",
            os.path.basename(args.load_state),
        )
        + ".csv"
    )
    ...
    los_path = os.path.join(
        os.path.join(
            args.output_dir,
            f"{args.data_subset}_predictions/los",
            os.path.basename(args.load_state),
        )
        + ".csv"
    )
    ...
    pheno_path = os.path.join(
        os.path.join(
            args.output_dir,
            f"{args.data_subset}_predictions/pheno",
            os.path.basename(args.load_state),
        )
        + ".csv"
    )
